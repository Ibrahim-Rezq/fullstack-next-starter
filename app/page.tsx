            ...
            <section className='py-20 px-4 md:py-32 bg-gradient-to-b from-background to-muted/20'>
                <div className='container mx-auto text-center'>
                    ...
                    <p className='text-xl text-muted-foreground mb-8 max-w-2xl mx-auto'>
                        A production-ready Next.js starter with shadcn/ui,
                        TypeScript, and everything you need to ship your app
                        quickly.
                    </p>
                ...
                <div className='container mx-auto'>
                    <div className='text-center mb-12'>
                        ...
                        <p className='text-muted-foreground text-lg max-w-2xl mx-auto'>
                            Pre-configured with the best tools and practices to
                    ...
                    <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-6'>
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Built on Next.js 14+ with App Router for
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Powered by shadcn/ui with customizable
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Full TypeScript support for better developer
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Pre-built components including tables,
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Clean code structure with best practices and
                                    easy customization
                                </CardDescription>
                            </CardHeader>
                        </Card>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Optimized for Vercel, Netlify, or any
                                    hosting platform you prefer
                                </CardDescription>
                            </CardHeader>
                        </Card>
                    </div>
            ...
            <section className='py-20 px-4'>
                <div className='container mx-auto text-center'>
                    ...
                    <p className='text-muted-foreground text-lg mb-8 max-w-2xl mx-auto'>
                        Start building your next project with this starter
                        template today
                    </p>
                    <Link href='/dashboard/users'>
